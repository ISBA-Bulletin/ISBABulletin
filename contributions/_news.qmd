...
Some side details (not essential to include, but maybe useful context): The answer above is entirely written by me. When using GenAI tools, I mostly use Gemini, and occasionally ChatGPT, both in their unpaid versions. I have written some non-publication research notes ([A](https://drive.google.com/file/d/1tEie57t5zbVhC8tyKCPfpiDT8EbfnPWy/view), [B](https://drive.google.com/file/d/1msTayZJ3NgIPPcl2L5pMpD8-x6nTUP0P/view)) which involve low-level mathematical contributions from LLMs.
...
- [The Bayesian Young Statisticians Meeting (BAYSM) 2026](https://baysm2026.github.io/), 26-27 July 2026, Chiba University, Japan. The keynote speakers will be Prof. Kerrie Mengersen and Prof. Kengo Kamatani.

- [4$^{th}$ Bayesian Nonparametrics (BNP) Networking Workshop](https://bnpnetworking2026.github.io/), 6-10 July 2026, Seoul, South Korea. This meeting is organised by the Bayesian Nonparametrics (BNP) Section and aims to enhance networking within the BNP community, particularly for junior researchers.
