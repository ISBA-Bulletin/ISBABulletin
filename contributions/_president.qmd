...
As we were putting the finishing touches on this issue, we learned also the sad news of Martin A. Tanner's passing. He made remarkable contributions to Bayesian computation and public health, and was a recipient of the prestigious Mortimer Spiegelman Award. For an obituary see [here](https://statistics.northwestern.edu/people/in-memoriam/martin-tanner.html).
